...
const db = new sqlite3.Database('argimes.db');

// Lisez le fichier create_tables.sql et exécutez-le
const createTablesSQL = fs.readFileSync('./database/create_tables.sql', 'utf-8');
db.exec(createTablesSQL, (err) => {
  if (err) {
    ...
    const insertDataSQL = fs.readFileSync('./database/insert_datas.sql', 'utf-8');
